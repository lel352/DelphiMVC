...
begin
   if memTableClientes.RecordCount > 0 then begin
      ...
      ShowMessage('Não a dados para excluir!!!');
   end;
end;
...
begin
   if memTableClientes.RecordCount > 0 then begin
      ...
      botao := Application.MessageBox('Deseja excluir o registro?','Corfirmação',MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
...
begin
   ...
   editNome.Text := memTableClientesNome.AsString;
end;
